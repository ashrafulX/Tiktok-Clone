...
def home(request):
    ...
    for repost in reposts:
        ...
        post.is_repost = True
        repostedposts.append(post)
    
    feed = sorted(
        chain(posts, repostedposts),
    ...
    if request.GET.get('paginator'):
        return render(request, 'posts/partials/posts.html', context)
    
    if request.htmx:
        return render(request, 'posts/partials/home.html', context)
...
def explore(request):
    ...
    if request.htmx:
        return render(request, 'posts/partials/explore.html', context)
...
def post_page_view(request, pk=None):
    ...
    if request.method == "POST":
        ...
        return render(request, 'posts/partials/comments/comment_loop.html', context)
    
    if post.author:
        authorposts = Post.objects.filter(author=post.author).order_by('-created_at')
        prev_post = authorposts.filter(created_at__gt=post.created_at).last()
        next_post = authorposts.filter(created_at__lt=post.created_at).first()
    else:
        authorposts = [ post ]
    ...
    if request.htmx:
        return render(request, 'posts/partials/postpage.html', context)
...
def like_post(request, pk=None):
    ...
    if request.GET.get('home'):
        return render(request, 'posts/partials/like_home.html', context)
    
    if request.GET.get('postpage'):
        return render(request, 'posts/partials/like_postpage.html', context)
...
def bookmark_post(request, pk=None):
    ...
    if request.GET.get('home'):
        return render(request, 'posts/partials/bookmark_home.html', context)
    
    if request.GET.get('postpage'):
        return render(request, 'posts/partials/bookmark_postpage.html', context)
...
def comment(request, pk=None):
    ...
    if request.GET.get('hide_replies'):
        return render(request, 'posts/partials/comments/button_view_replies.html', context)
    
    if request.GET.get('reply_form'):
        return render(request, 'posts/partials/comments/form_add_reply.html', context)
    
    return render(request, 'posts/partials/comments/reply_loop.html', context)
...
def comment_delete(request, pk=None):
    ...
    return render(request, 'posts/partials/comments/from_comment_delete.html', context)
...
def comment_like(request, pk=None):
    ...
    return render(request, 'posts/partials/comments/button_like_comment.html', context)
...
def share_post(request, pk=None):
    ...
    if request.htmx:
        return render(request, 'posts/partials/post_share.html', context)